...
const RARE_GOODS=[{id:'amber_seed',sellPrice:50,skill:'woodcutting',reservationGroup:'heartwood_totem'},{id:'golden_bough',sellPrice:500,skill:'woodcutting',reservationGroup:'heartwood_totem'},{id:'crystal_gem',sellPrice:50,skill:'mining',reservationGroup:'deepcore_resonator'},{id:'meteor_core',sellPrice:500,skill:'mining',reservationGroup:'deepcore_resonator'},{id:'sunken_relic',sellPrice:50,skill:'fishing',reservationGroup:'relicbound_tackle'},{id:'pearl_hook',sellPrice:500,skill:'fishing',reservationGroup:'relicbound_tackle'}];
function rareGoodDefinition(id){return RARE_GOODS.find(g=>g.id===id)}
function rareGoodReservation(id){const g=rareGoodDefinition(id),r=g&&typeof nextGatheringUpgradeRecipe==='function'?nextGatheringUpgradeRecipe(g.reservationGroup):null;return {qty:r?(r.materials[id]||0):0,recipe:r}}
